...
const relayFieldGroups: Array<{
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "templateGroomingCompletedWithoutReport", label: "미용 완료 - 케어리포트 없음", placeholder: "grooming_completed_without_report" },
...
const appFieldGroups: Array<{
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "templateGroomingCompletedWithoutReport", label: "미용 완료 - 케어리포트 없음" },
