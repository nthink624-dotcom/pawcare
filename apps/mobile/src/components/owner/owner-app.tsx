              ...
              <div className="flex min-h-0 flex-1 flex-col gap-2">
                <div className="min-h-0 flex-1">
                  <TodayConfirmedContent
                    ...
                    onCompleteWithoutPhoto={requestMobileGroomingCompletion}
      ...
      {mobileGroomingStartAction ? (
        <OwnerMobileGroomingStartSheet
          ...
          onPhotoAction={() => {
            const action = mobileGroomingStartAction;
            setMobileGroomingStartAction(null);
            void openMobilePhotoStatusAction(action.appointmentId, action.phase === "completion" ? "completed" : "in_progress", false, false);
          }}
          onDirectAction={() => {
            const action = mobileGroomingStartAction;
            setMobileGroomingStartAction(null);
