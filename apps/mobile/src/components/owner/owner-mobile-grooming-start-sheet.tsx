...
export default function OwnerMobileGroomingStartSheet({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-end justify-center bg-[#0d1726]/45 pt-12" onClick={() => { if (!busy) onClose(); }}>
      <section
        ref={dialogRef}
        role="dialog"
        aria-modal="true"
        ...
        tabIndex={-1}
        className="max-h-[calc(100dvh-48px)] w-full max-w-[430px] overflow-y-auto rounded-t-[18px] bg-white shadow-[0_-8px_24px_rgba(15,23,42,0.16)]"
        ...
        {isEarlyConfirm ? (
          <div className="grid grid-cols-2 gap-2 px-5 pb-[calc(env(safe-area-inset-bottom)+20px)]">
            <button
              ...
              disabled={busy}
              onClick={onClose}
              className="min-h-[52px] rounded-[14px] border border-[#d7e0eb] bg-white px-3 py-3 text-[16px] font-medium leading-6 text-[#526276] outline-none focus-visible:ring-2 focus-visible:ring-[#2563eb] focus-visible:ring-offset-2 disabled:opacity-50"
            >
              아니요
            </button>
            <button
              ...
              className="min-h-[52px] rounded-[14px] bg-[#111a30] px-3 py-3 text-[16px] font-medium leading-6 text-white outline-none focus-visible:ring-2 focus-visible:ring-[#2563eb] focus-visible:ring-offset-2 disabled:opacity-55"
            >
              예, 시작할게요
            </button>
          </div>
          ...
          <div className="space-y-2 px-5 pb-[calc(env(safe-area-inset-bottom)+20px)]">
            <button
              ...
              className="min-h-[52px] w-full rounded-[14px] px-4 py-3 text-[16px] font-medium leading-6 text-white outline-none focus-visible:ring-2 focus-visible:ring-[#2563eb] focus-visible:ring-offset-2 disabled:opacity-55"
            ...
            <button
              ...
              className="min-h-[52px] w-full rounded-[14px] border bg-white px-4 py-3 text-[16px] font-medium leading-6 outline-none focus-visible:ring-2 focus-visible:ring-[#2563eb] focus-visible:ring-offset-2 disabled:opacity-55"
