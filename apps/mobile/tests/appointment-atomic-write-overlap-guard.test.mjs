...
const migrationPath = new URL(
  "../../../supabase/migrations/20260914214756_repair_appointment_atomic_write_overlap_guard.sql",
  import.meta.url,
);
...
test("owner success side effects start only after the single database write resolves", () => {
  ...
  assert.doesNotMatch(databaseUpdateBlock, /await dispatchNotification\(/);
});
