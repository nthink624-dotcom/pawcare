...
const WEB_SIZE_CLASS_MAP: Record<AppButtonSize, string> = {
...
const MOBILE_SIZE_CLASS_MAP: Record<AppButtonSize, string> = {
...
function createAppButton(sizeClassMap: Record<AppButtonSize, string>) {
  return forwardRef<HTMLButtonElement, AppButtonProps>(function AppButton(
