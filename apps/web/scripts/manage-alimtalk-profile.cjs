...
const profiles = {
  neomchin: {
    ...
    templates: {
      ALIMTALK_TEMPLATE_BOOKING_CONFIRMED: "booking_confirmed_v2",
      ALIMTALK_TEMPLATE_BOOKING_CANCELLED: "booking_cancelled_v4",
      ...
      ALIMTALK_TEMPLATE_APPOINTMENT_REMINDER_10M: "appointment_reminder_10m_v2",
      ALIMTALK_TEMPLATE_VISIT_SCHEDULE_NOTICE: "visit_schedule_notice_v2",
      ALIMTALK_TEMPLATE_VISIT_REMINDER_NOTICE: "visit_reminder_notice_v2",
      ALIMTALK_TEMPLATE_GROOMING_STARTED: "grooming_started_v4",
      ALIMTALK_TEMPLATE_GROOMING_ALMOST_DONE: "grooming_almost_done_v3",
      ALIMTALK_TEMPLATE_GROOMING_COMPLETED: "grooming_completed_v3",
      ALIMTALK_TEMPLATE_GROOMING_COMPLETED_WITHOUT_REPORT: "grooming_completed_noreport_v1",
    },
  },
};
