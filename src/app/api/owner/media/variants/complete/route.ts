...
import { completeOwnerMediaVariantUpload } from "@/server/media-variant-service";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await completeOwnerMediaVariantUpload(owner, {
    ...
    const message = error instanceof Error ? error.message : "Could not complete media variant upload.";
