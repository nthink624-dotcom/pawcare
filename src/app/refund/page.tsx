...
const refundSummary = `넘친 Day는 카드 등록 없이 2주 무료체험을 시작하고, 계속 사용하려는 시점에 직접 결제를 진행하는 방식으로 운영됩니다.
...
- 베이직, 스탠다드, 프로는 모두 월 단위 정기결제 상품입니다.
- 각 요금제는 직원 수와 포함 알림톡 건수 기준으로 구분되며, 초과 알림톡은 11원/건(부가세 포함)으로 과금될 수 있습니다.
