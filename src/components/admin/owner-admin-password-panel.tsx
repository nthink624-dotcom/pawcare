    ...
    <section className="rounded-[18px] border border-[#ebe5dc] bg-[#fcfbf8] p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          <p className="text-[14px] font-semibold text-[#171411]">계정 접근 관리</p>
      ...
      <div className="mt-4 rounded-[14px] border border-[#e5ddd2] bg-white px-4 py-3">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <p className="text-[12px] font-semibold text-[#8a8277]">로그인 아이디</p>
            <p className="mt-1 truncate text-[14px] font-semibold text-[#171411]">{loginId ?? "-"}</p>
          </div>
          <button
            type="button"
            onClick={onIssue}
            disabled={!canIssue || issuing}
            className="inline-flex h-[38px] shrink-0 items-center justify-center rounded-[12px] bg-[#1f6b5b] px-3 text-[12px] font-semibold text-white disabled:bg-[#c8d3cf]"
          >
            {issuing ? (
        ...
        {!canIssue ? (
          <p className="mt-3 rounded-[12px] bg-[#fff7ed] px-3 py-2 text-[12px] leading-5 text-[#9a5b24]">
      ...
      {result ? (
        <div className="mt-3 rounded-[14px] border border-[#d7e7e1] bg-[#f4faf7] px-4 py-3">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              <p className="text-[12px] font-semibold text-[#1f6b5b]">발급된 임시비밀번호</p>
            ...
            <button
              ...
              className="inline-flex h-[34px] shrink-0 items-center gap-1.5 rounded-[10px] border border-[#cfe1da] bg-white px-2.5 text-[12px] font-semibold text-[#1f6b5b]"
            >
