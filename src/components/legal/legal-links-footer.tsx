    ...
    <footer className="mt-10 border-t border-[#dfe4e8] pt-6 text-[#69747e]">
      <div className="grid gap-5 md:grid-cols-[1fr_auto] md:items-end">
        <div className="space-y-1">
          <p className="text-[15px] font-bold text-[#303840]">{LEGAL_BUSINESS_INFO.serviceName}</p>
          <p className="text-[15px] leading-5">{LEGAL_SERVICE_OPERATOR_NOTICE}</p>
          ...
          <p className="text-[15px] leading-5">주소 {LEGAL_BUSINESS_INFO.address}</p>
          <p className="text-[15px] leading-5">
          고객센터 {LEGAL_BUSINESS_INFO.customerServicePhone} · {LEGAL_BUSINESS_INFO.customerServiceEmail}
          </p>
        </div>
        <div className="flex flex-wrap gap-x-4 gap-y-2 text-[15px] font-semibold text-[#46515b] md:justify-end">
