    ...
    <>
      <section className="mt-6 border-t border-[#e2e8f0] pt-5" aria-labelledby="price-guide-surcharge-title">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div>
            <h3 id="price-guide-surcharge-title" className="text-[16px] font-semibold leading-6 text-[#172033]">추가요금</h3>
            <p className="mt-1 text-[13px] font-normal leading-5 text-[#64748b]">표에 함께 안내할 조건만 추가해 주세요.</p>
          </div>
          <button
            type="button"
            onClick={() => {
          ...
          >
            <Plus className="h-4 w-4" aria-hidden="true" />추가요금
          </button>
        </div>
      ...
      <section className="mt-6 border-t border-[#e2e8f0] pt-5" aria-labelledby="price-guide-overall-note-title">
        <h3 id="price-guide-overall-note-title" className="text-[16px] font-semibold leading-6 text-[#172033]">전체 메모</h3>
        {activeField === "price-guide-overall-note" ? (
          <div className="mt-3">
            ...
            <textarea
              ...
              onChange={(event) => onChange(resolvePriceGuideV2Reviews(
