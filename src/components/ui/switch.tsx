...
export type SwitchProps = Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "children" | "onChange"> & {
  checked?: boolean;
...
export const Switch = React.forwardRef<HTMLButtonElement, SwitchProps>(function Switch(
  { checked = false, className, disabled, size = "md", thumbClassName, onCheckedChange, onClick, ...props },
  ref,
) {
  return (
    <button
