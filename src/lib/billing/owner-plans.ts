...
export const ownerPlans: OwnerPlan[] = [
  ...
  makePlan({
    ...
    shortTitle: "베이직",
    monthlyPrice: 19000,
    description: "혼자 운영하는 1인샵이 예약, 고객, 미용 기록을 정리하기 좋은 시작 플랜입니다.",
  ...
  makePlan({
    ...
    shortTitle: "스탠다드",
    monthlyPrice: 29000,
    description: "오너와 직원이 함께 예약을 나눠 보는 소형 팀 매장에 맞춘 운영 플랜입니다.",
    badge: "추천",
