...
export const demoAppointments: Appointment[] = [
  ...
  { id: "a-10", shop_id: "demo-shop", guardian_id: "g-1", pet_id: "p-1", service_id: "svc-care", appointment_date: today, appointment_time: "10:00", status: "confirmed", memo: "발톱만 빠르게", rejection_reason: null, start_at: at(today, "10:00"), end_at: at(today, "10:15"), source: "customer", created_at: now, updated_at: now },
  { id: "a-11", shop_id: "demo-shop", guardian_id: "g-2", pet_id: "p-3", service_id: "svc-care", appointment_date: today, appointment_time: "10:15", status: "confirmed", memo: "귀 청소 추가 문의", rejection_reason: null, start_at: at(today, "10:15"), end_at: at(today, "10:45"), source: "customer", created_at: now, updated_at: now },
  { id: "a-12", shop_id: "demo-shop", guardian_id: "g-3", pet_id: "p-4", service_id: "svc-bath-only", appointment_date: today, appointment_time: "12:15", status: "confirmed", memo: "첫 방문 접수", rejection_reason: null, start_at: at(today, "12:15"), end_at: at(today, "13:00"), source: "customer", created_at: now, updated_at: now },
  ...
  { id: "a-14", shop_id: "demo-shop", guardian_id: "g-2", pet_id: "p-3", service_id: "svc-bath-only", appointment_date: today, appointment_time: "13:45", status: "confirmed", memo: "오후 접수", rejection_reason: null, start_at: at(today, "13:45"), end_at: at(today, "14:45"), source: "customer", created_at: now, updated_at: now },
  ...
  { id: "a-17", shop_id: "demo-shop", guardian_id: "g-2", pet_id: "p-3", service_id: "svc-care", appointment_date: today, appointment_time: "18:15", status: "confirmed", memo: "당일 접수", rejection_reason: null, start_at: at(today, "18:15"), end_at: at(today, "18:45"), source: "customer", created_at: now, updated_at: now },
  ...
  { id: "a-19", shop_id: "demo-shop", guardian_id: "g-1", pet_id: "p-2", service_id: "svc-bath", appointment_date: today, appointment_time: "20:00", status: "confirmed", memo: "마감 전 접수", rejection_reason: null, start_at: at(today, "20:00"), end_at: at(today, "21:20"), source: "customer", created_at: now, updated_at: now },
  ...
  { id: "a-21", shop_id: "demo-shop", guardian_id: "g-3", pet_id: "p-4", service_id: "svc-care", appointment_date: today, appointment_time: "22:15", status: "confirmed", memo: "야간 접수 테스트", rejection_reason: null, start_at: at(today, "22:15"), end_at: at(today, "22:45"), source: "customer", created_at: now, updated_at: now },
  ...
  { id: "a-24", shop_id: "demo-shop", guardian_id: "g-1", pet_id: "p-2", service_id: "svc-care", appointment_date: today, appointment_time: "11:15", status: "confirmed", memo: "대기 카드 테스트", rejection_reason: null, start_at: at(today, "11:15"), end_at: at(today, "11:45"), source: "customer", created_at: now, updated_at: now },
  ...
  { id: "a-27", shop_id: "demo-shop", guardian_id: "g-3", pet_id: "p-4", service_id: "svc-bath-only", appointment_date: today, appointment_time: "14:45", status: "confirmed", memo: "오후 대기 테스트", rejection_reason: null, start_at: at(today, "14:45"), end_at: at(today, "15:30"), source: "customer", created_at: now, updated_at: now },
  ...
  { id: "a-30", shop_id: "demo-shop", guardian_id: "g-1", pet_id: "p-1", service_id: "svc-care", appointment_date: today, appointment_time: "17:00", status: "confirmed", memo: "저녁 대기 테스트", rejection_reason: null, start_at: at(today, "17:00"), end_at: at(today, "17:30"), source: "customer", created_at: now, updated_at: now },
  ...
  { id: "a-33", shop_id: "demo-shop", guardian_id: "g-2", pet_id: "p-3", service_id: "svc-bath-only", appointment_date: today, appointment_time: "20:45", status: "confirmed", memo: "야간 대기 테스트", rejection_reason: null, start_at: at(today, "20:45"), end_at: at(today, "21:30"), source: "customer", created_at: now, updated_at: now },
  ...
  { id: "a-36", shop_id: "demo-shop", guardian_id: "g-3", pet_id: "p-4", service_id: "svc-bath-only", appointment_date: today, appointment_time: "11:50", status: "confirmed", memo: "랜덤 테스트 2", rejection_reason: null, start_at: at(today, "11:50"), end_at: at(today, "12:35"), source: "customer", created_at: now, updated_at: now },
  ...
  { id: "a-39", shop_id: "demo-shop", guardian_id: "g-2", pet_id: "p-3", service_id: "svc-bath-only", appointment_date: today, appointment_time: "14:55", status: "confirmed", memo: "랜덤 테스트 5", rejection_reason: null, start_at: at(today, "14:55"), end_at: at(today, "15:40"), source: "customer", created_at: now, updated_at: now },
  ...
  { id: "a-41", shop_id: "demo-shop", guardian_id: "g-1", pet_id: "p-2", service_id: "svc-care", appointment_date: today, appointment_time: "16:45", status: "confirmed", memo: "랜덤 테스트 7", rejection_reason: null, start_at: at(today, "16:45"), end_at: at(today, "17:15"), source: "customer", created_at: now, updated_at: now },
  ...
  { id: "a-44", shop_id: "demo-shop", guardian_id: "g-1", pet_id: "p-1", service_id: "svc-bath", appointment_date: today, appointment_time: "22:35", status: "confirmed", memo: "랜덤 테스트 10", rejection_reason: null, start_at: at(today, "22:35"), end_at: at(today, "23:55"), source: "customer", created_at: now, updated_at: now },
