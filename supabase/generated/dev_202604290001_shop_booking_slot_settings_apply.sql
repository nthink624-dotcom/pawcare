-- Development Supabase follow-up apply SQL
-- Target project: petmanager-dev (qefxdtmdtvnzgupmjlom)
-- Source migration: supabase/migrations/202604290001_shop_booking_slot_settings.sql
-- Purpose: restore booking slot columns required by /api/dev/create-owner.
