...
-- Purpose: 서비스 관리 화면의 카테고리, 설명, 정렬, 담당 가능 직원, 요금표, 추가 비용 기준을 DB에 저장할 수 있게 합니다.
-- Apply after the staff schema hotfix if the target database still lacks public.staff_members.
